import{S as y,i as c,a as h}from"./assets/vendor-e6ae6a6a.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function n(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerpolicy&&(o.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?o.credentials="include":e.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(e){if(e.ep)return;e.ep=!0;const o=n(e);fetch(e.href,o)}})();const t={gallery:document.querySelector(".gallery-container"),form:document.querySelector(".form"),loader:document.querySelector(".loader"),loadMoreBtn:document.querySelector(".btn-load-more")},i={query:"",page:1,maxPage:0,per_page:40},L=new y(".gallery-link",{captions:!0,captionSelector:"img",captionDelay:250,captionPosition:"bottom",captionsData:"alt"});t.form.addEventListener("submit",v);async function v(a){a.preventDefault();const r=a.currentTarget,n=r.elements.query,s=r.elements.searchBtn;t.gallery.innerHTML="",t.loader.classList.add("show"),s.disabled=!0,t.loadMoreBtn.classList.add("is-hidden");const e=document.querySelector(".iziToast");if(e&&c.hide({transitionOut:"fadeOutUp"},e),t.query=n.value.trim(),!!t.query)try{const{hits:o,totalHits:l}=await d(t.query);i.maxPage=Math.ceil(l/i.per_page),u(o),g(),o.length&&o.length!==l?(t.loadMoreBtn.classList.remove("is-hidden"),t.loadMoreBtn.addEventListener("click",f)):o.length||c.show({message:"Sorry, there are no images matching your search query. Please, try again!",messageColor:"#FAFAFB",messageSize:"16px",messageLineHeight:"24px",color:"#EF4040",progressBarColor:"#B51B1B",position:"topRight",icon:"icon-cancel",iconColor:"#FAFAFB"})}catch(o){console.log(o)}finally{t.loader.classList.remove("show"),r.reset(),s.disabled=!1}}async function d(a){const r={key:"41767472-d86fe691fef3335ff5b770a4f",q:`${a}`,image_type:"photo",orientation:"horizontal",safesearch:!0,page:i.page,per_page:i.per_page},n="https://pixabay.com/api/";return h.get(`${n}`,{params:r}).then(({data:s})=>s)}function u(a){const r=a.map(({webformatURL:n,largeImageURL:s,tags:e,likes:o,views:l,comments:p,downloads:m})=>`
